...
public class UserLevel {
    ...
    public Integer getPriviledgeUserPrice() {
        return priviledgeUserPrice;
    }

    public void setPriviledgeUserPrice(Integer priviledgeUserPrice) {
        this.priviledgeUserPrice = priviledgeUserPrice;
    }
